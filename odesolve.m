...
switch action
    case 'initialize'
        ...
        odesolveset = figure('name','ODESOLVE Setup','numbertitle','off',...
        ...
        meload = uimenu(mefile,'label','Load a system ...',...
            'callback','odesolve(''loadsyst'',''system'');',...
            'pos',1);
        mesave = uimenu(mefile,'label','Save the current system ...',...
            'callback','odesolve(''savesyst'',''system'');',...
            'pos',2);
        meloadg = uimenu(mefile,'label','Load a gallery ...',...
            'callback','odesolve(''loadsyst'',''gallery'');',...
            'separator','on','pos',3);
        mesaveg = uimenu(mefile,'label','Save a gallery ...',...
            'callback','odesolve(''savesyst'',''gallery'');',...
            'tag','savegal',...
            'pos',4);
        ...
        melddg = uimenu(mefile,'label','Load the default gallery.',...
            'callback','odesolve(''loadsyst'',''default'');',...
            'enable','off',...
            'tag','load default',...
            'pos',6);
        ...
        merestart = uimenu(mefile,'label',...
            'Restart ODESOLVE.',...
            'callback','odesolve(''restart'')',...
            'separator','on','pos',12);
        
        mequit = uimenu(mefile,...
            'label','Quit ODESOLVE',...
            'callback','odesolve(''quit'')',...
        ...
        mefileexport = uimenu(optmenu,'label','Export ODE function file.',...
            'callback','odesolve(''fileexport'')',...
            'visible','off');
        
        mesolvset = uimenu(optmenu,'label','Solver settings.',...
            'callback','odesolve(''settings'')',...
            'visible','off');
